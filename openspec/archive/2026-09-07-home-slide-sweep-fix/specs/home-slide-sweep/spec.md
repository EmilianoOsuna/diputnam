...
La home SHALL mantener el título, descripción y acciones de la escena activa anclados alrededor del centro del viewport durante el recorrido. El copy no SHALL desplazarse verticalmente como un bloque normal para provocar el cambio de escena.

#### Scenario: Copy durante el scroll

- **WHEN** una persona desplaza la home entre dos escenas
- **THEN** el copy permanece en el centro de la composición mientras la transición ocurre detrás y delante de esa capa
...
La implementación SHALL verificarse con Playwright en desktop y mobile, cubriendo el estado inicial, un barrido en progreso, el final de una transición, el regreso al inicio, refresh y movimiento reducido.
