...
- [Reactivar GSAP en Putnam móvil cuesta ms de arranque] → sin Lenis, sin parallax en `< 768px`, `will-change` sólo en hero; medir con el guion de `mobile-60fps/performance-notes.md` antes/después.
