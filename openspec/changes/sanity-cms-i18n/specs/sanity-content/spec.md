...
- **THEN** las doce rutas se generan con el contenido publicado y ningún `.html` referencia texto o imagen que no provenga del CMS o del diccionario de interfaz
