...
- **THEN** la escena activa ocupa exactamente el viewport (borde superior en 0 y borde inferior en la altura del viewport, ±1 px) y ninguna parte de la escena anterior o siguiente queda visible, incluso si no se ejecuta ningún manejador de `resize`
