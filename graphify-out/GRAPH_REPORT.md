...
## Corpus Check
- 229 files · ~2,314,006 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2021 nodes · 2343 edges · 166 communities (163 shown, 3 thin omitted)
...
4. `../components/ContactFooter.astro` - 18 edges
5. `scripts` - 17 edges
...
Cohesion: 0.09
Nodes (27): ../assets/putnam-dark.png, ../assets/putnam-light.png, ../i18n, ../lib/content, ../styles/contacto.css, ../styles/global.css, ../styles/not-found.css, ../styles/noticias.css (+19 more)
...
Cohesion: 0.13
Nodes (21): ../components/SiteHead.astro, alternates, canonical, graph, image, pair, path, ui (+13 more)
...
Cohesion: 0.09
Nodes (30): Contacto, Eredita, erediteHero(), erediteIntro(), getContacto(), getEredita(), getLegalDocs(), getNoticiasPage() (+22 more)
...
Cohesion: 0.16
Nodes (20): ../assets/eredita-logo.png, ../lib/images, ../lib/seo, ../styles/eredita.css, ../components/BodyImage.astro, ../components/CmsImg.astro, position, src (+12 more)
...
Cohesion: 0.26
Nodes (13): notaPath(), PageKey, projectPath(), getNotas(), getProyectos(), getSettings(), getUpdatedAt(), absolute() (+5 more)
...
## Knowledge Gaps
- **1167 isolated node(s):** `name`, `version`, `description`, `dev`, `build` (+1162 more)
...
- **Why does `../components/SiteHead.astro` connect `ADDED Requirements` to `eredita.astro`, `ADDED Requirements`, `tasks.md`, `check-dist.mjs`, `proposal.md`?**
