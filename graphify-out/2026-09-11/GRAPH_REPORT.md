...
Cohesion: 0.07
Nodes (27): astro, gsap, lenis, author, bugs, url, dependencies, astro (+19 more)
...
Cohesion: 0.09
Nodes (21): home-ui Specification, Purpose, Requirement: Animación y scroll, Requirement: Contenido inicial de la home, Requirement: Experiencia responsive y movimiento reducido, Requirement: Hero de Putnam, Requirement: Home visualmente fiel a la referencia, Requirement: Navegación y contacto legibles (+13 more)

### Community 6 - "Requirement: Movimiento premium y controlado"
Cohesion: 0.10
Nodes (20): home-ui-motion-readability Specification, Purpose, Requirement: Legibilidad sobre imágenes, Requirement: Movimiento premium y controlado, Requirement: Responsive y movimiento reducido, Requirement: Stage de slides con título persistente, Requirement: Tipografía editorial de la referencia, Requirements (+12 more)
...
Cohesion: 0.24
Nodes (9): header, logo, menuToggle, mobileViewport, scheduleThemeUpdate(), setMenuOpen(), siteNav, themedSections (+1 more)
...
Cohesion: 0.40
Nodes (4): https://dsgninterior.se/en, https://senawastudio.com/, https://www.era-residence.com/, THE SMOOTHNESS EVEN IN MOBILE - RESEARCH IT'S OPTIMIZATION
