...
export const eredita = {
  ...
  project: { status: 'Pre-sale', card: 'The first building of the Ereditá line: studios, one- and two-bedroom apartments with shared amenities designed for community life.' },
  projects: { kicker: 'Projects', title: 'The buildings\nof the Ereditá line.', text: 'Every Ereditá project shares the same idea of thoughtful, safe and durable housing, adapted to its location.' },
  gallery: {
